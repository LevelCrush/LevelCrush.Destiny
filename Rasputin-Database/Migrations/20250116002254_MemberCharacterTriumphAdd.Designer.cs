...
namespace Rasputin.Database.Migrations
{
    ...
    [Migration("20250116002254_MemberCharacterTriumphAdd")]
    partial class MemberCharacterTriumphAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rasputin.Database.Models.MemberCharacter", b =>
                {
                    ...
                    b.Property<long>("MinutesPlayedLifetime")
                        .HasColumnType("bigint")
                        .HasColumnName("minutes_played_lifetime");

                    b.Property<long>("MinutesPlayedSession")
                        .HasColumnType("bigint")
